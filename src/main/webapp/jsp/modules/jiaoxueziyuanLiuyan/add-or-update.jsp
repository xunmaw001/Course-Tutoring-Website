    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑教学资源评价</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">教学资源评价管理</li>
                        <li class="breadcrumb-item active">编辑教学资源评价</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">教学资源评价信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    <div class="form-group col-md-6 aaaaaa jiaoxueziyuan">
                                        <label>教学资源</label>
                                        <div>
                                            <select id="jiaoxueziyuanSelect" name="jiaoxueziyuanSelect"
                                    ...
                                    <div class="form-group col-md-6 jiaoxueziyuan">
                                        <label>教学资源名称</label>
                                        <input id="jiaoxueziyuanName" name="jiaoxueziyuanName" class="form-control"
                                               placeholder="教学资源名称" readonly>
                                    </div>
                                    <div class="form-group col-md-6 jiaoxueziyuan">
                                        <label>资源类型</label>
                                        <input id="jiaoxueziyuanValue" name="jiaoxueziyuanValue" class="form-control"
                                               placeholder="资源类型" readonly>
                                    </div>
                                    <div class="form-group col-md-6 jiaoxueziyuan">
                                        <label>赞</label>
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group  col-md-6">
                                        <label>评价内容</label>
                                        <script id="jiaoxueziyuanLiuyanContentEditor" type="text/plain"
                                                style="width:100%;height:230px;"></script>
                                        <script type = "text/javascript" >
                                        //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
                                        //相见文档配置属于你自己的编译器
                                        var jiaoxueziyuanLiuyanContentUe = UE.getEditor('jiaoxueziyuanLiuyanContentEditor', {
                                            toolbars: [
                                                [
                                                    'undo', //撤销
                                                    'bold', //加粗
                                        ...
                                        <input type="hidden" name="jiaoxueziyuanLiuyanContent" id="jiaoxueziyuanLiuyanContent-input">
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <label>回复内容</label>
...
<script>
    ...
    function upload() {
        ...
        $('#jiaoxueziyuanLiuyanContentupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                UE.getEditor('jiaoxueziyuanLiuyanContentEditor').execCommand('insertHtml', '<img src=\"' + baseUrl + 'upload/' + data.result.file + '\" width=900 height=560>');
            }
        });
    ...
    function setContent() {
        ...
        <!-- 当前表的填充富文本框 -->
        if (ruleForm.jiaoxueziyuanLiuyanContent != null && ruleForm.jiaoxueziyuanLiuyanContent != 'null' && ruleForm.jiaoxueziyuanLiuyanContent != '') {

            var jiaoxueziyuanLiuyanContentUeditor = UE.getEditor('jiaoxueziyuanLiuyanContentEditor');
            jiaoxueziyuanLiuyanContentUeditor.ready(function () {
                var mes = '';
                if(ruleForm.jiaoxueziyuanLiuyanContent != null){
                    mes = ''+ ruleForm.jiaoxueziyuanLiuyanContent;
                    mes = mes.replace(/\n/g, "<br>");
                }
                jiaoxueziyuanLiuyanContentUeditor.setContent(mes);
            });
        }
    ...
    function getContent() {
        ...
        <!-- 获取当前表的富文本框内容 -->
            var jiaoxueziyuanLiuyanContentEditor = UE.getEditor('jiaoxueziyuanLiuyanContentEditor');
            if (jiaoxueziyuanLiuyanContentEditor.hasContents()) {
                $('#jiaoxueziyuanLiuyanContent-input').attr('value', jiaoxueziyuanLiuyanContentEditor.getPlainTxt());
            }
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                yonghuId: "required",
                jiaoxueziyuanLiuyanContent: "required",
            ...
            messages: {
                ...
                yonghuId: "用户不能为空",
                jiaoxueziyuanLiuyanContent: "评价内容不能为空",
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#jiaoxueziyuanLiuyanContent").val(ruleForm.jiaoxueziyuanLiuyanContent);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            var jiaoxueziyuanLiuyanContentUeditor = UE.getEditor('jiaoxueziyuanLiuyanContentEditor');
            jiaoxueziyuanLiuyanContentUeditor.ready(function () {
                jiaoxueziyuanLiuyanContentUeditor.setDisabled('fullscreen');
            });
