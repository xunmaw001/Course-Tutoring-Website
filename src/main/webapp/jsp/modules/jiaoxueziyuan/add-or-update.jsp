                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>资源类型</label>
                                        <select id="jiaoxueziyuanTypesSelect" name="jiaoxueziyuanTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>赞</label>
                                        <input id="zanNumber" name="zanNumber" value="0" class="form-control"
                                               onchange="zanNumberChickValue(this)" readonly placeholder="赞">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label>踩</label>
                                        <input id="caiNumber" name="caiNumber" value="0" class="form-control"
                                               onchange="caiNumberChickValue(this)" readonly placeholder="踩">
                                    </div>
    ...
    function getContent() {
        ...
        if($("#jiaoxueziyuanContentupload").length>0) {
            ...
            if (jiaoxueziyuanContentEditor.hasContents()) {
                $('#jiaoxueziyuanContent-input').attr('value', jiaoxueziyuanContentEditor.getPlainTxt());
            }
        }
    }
    //数字检查
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                jiaoxueziyuanTypes: "资源类型不能为空",
                zanNumber: "赞不能为空",
                caiNumber: "踩不能为空",
                jiaoxueziyuanPhoto: "封面不能为空",
                jiaoxueziyuanFile: "教学资源下载不能为空",
                jiaoxueziyuanContent: "教学资源详情不能为空",
            }
        }).form();
    }
