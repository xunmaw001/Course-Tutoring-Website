            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">教学资源收藏展示</span>
                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jump('../jiaoxueziyuan/detail.jsp?id='+item.jiaoxueziyuanId)">
                                        <a href="#" class="ng-prsliik">
                                          <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.jiaoxueziyuanPhoto?item.jiaoxueziyuanPhoto.split(',')[0]:''" />
                                          </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jump('../jiaoxueziyuan/detail.jsp?id='+item.jiaoxueziyuanId)"><span>{{item.jiaoxueziyuanName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.jiaoxueziyuanNewMoney"><span style="color: red;">{{item.jiaoxueziyuanNewMoney}} RMB</span></div>
                                    <div class="ng-prslist-tit" ><span style="color: red;" @click="deleteJiaoxueziyuanCollection(item.id)">删除 {{item.jiaoxueziyuanName}} 收藏</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            jiaoxueziyuanCollectionTypes: 1,//类型
            limit: 10,
        ...
        filters: {
            //把 jiaoxueziyuanCollectionContent 字段去除无用字符 如果字段长度大于60  就截取到60
            jiaoxueziyuanCollectionContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                                    // 获取列表数据
            http.request('jiaoxueziyuanCollection/list', 'get', param, function(res) {
