            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">教学资源评价展示</span>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 jiaoxueziyuanLiuyanContent 字段去除无用字符 如果字段长度大于60  就截取到60
            jiaoxueziyuanLiuyanContent: function(val) {
                if (val) {
