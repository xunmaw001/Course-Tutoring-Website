                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../jiaoxueziyuan/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../jiaoxueziyuan/detail.jsp?id='+item.id)"><span>{{item.jiaoxueziyuanName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 jiaoxueziyuanContent 字段去除无用字符 如果字段长度大于60  就截取到60
            jiaoxueziyuanContent: function(val) {
                if (val) {
