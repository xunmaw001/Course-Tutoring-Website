...
<div id="app">
    <div class="data-detail">
        <div class="data-detail-breadcrumb">
            ...
            <!-- 收藏 -->
            <a onclick="addJiaoxueziyuanCollection()" href="javascript:void(0)">
                        ...
                        <div class="message-container">
                            <form class="layui-form message-form" style="padding-right: 20px;border-bottom: 0;">
                                <div class="layui-form-item layui-form-text">
                                    ...
                                    <div class="layui-input-block">
                                        <textarea name="jiaoxueziyuanLiuyanContent" id="jiaoxueziyuanLiuyanContent" required lay-verify="required" placeholder="留言内容"
                                                  class="layui-textarea"></textarea>
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
                                        <button class="layui-btn btn-submit" lay-submit lay-filter="jiaoxueziyuanLiuyanContent">立即提交</button>
                            ...
                            <div class="message-list">
                                <div class="message-item" v-for="(item,index) in jiaoxueziyuanLiuyanDataList" v-bind:key="index">
                                    ...
                                    <div class="content">
												<span class="message">
													留言:{{item.jiaoxueziyuanLiuyanContent}}
												</span>
                                    </div>
                                    <div class="content">
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        // 提交留言
        form.on('submit(jiaoxueziyuanLiuyanContent)', function (data) {
            data.yonghuId = localStorage.getItem('userid');
            data.tableName = localStorage.getItem('userTable');
            data.jiaoxueziyuanLiuyanContent =jquery("#jiaoxueziyuanLiuyanContent").val();
    ...
    // 添加
    /*function addJiaoxueziyuanqqqqqqqq(){
