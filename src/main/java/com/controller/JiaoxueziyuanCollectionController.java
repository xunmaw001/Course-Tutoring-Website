    ...
    */
    ...
    public R info(@PathVariable("id") Long id){
        ...
        if(jiaoxueziyuanCollection !=null){
            ...
            //级联表
            YonghuEntity yonghu = yonghuService.selectById(jiaoxueziyuanCollection.getYonghuId());
            if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody JiaoxueziyuanCollectionEntity jiaoxueziyuanCollection, HttpServletRequest request){
        ...
        if(StringUtil.isEmpty(role)){
            ...
            jiaoxueziyuanCollection.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        }
        Wrapper<JiaoxueziyuanCollectionEntity> queryWrapper = new EntityWrapper<JiaoxueziyuanCollectionEntity>()
            ...
            .eq("yonghu_id", jiaoxueziyuanCollection.getYonghuId())
            ;
